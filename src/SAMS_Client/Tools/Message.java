...
public class Message implements Serializable{
	...
	//attributes
	private String msgtype;	//type of message (request, recruit, ...etc)
	private Object msgobj;	//the object that message contains.
	private Object msgobj2;
	private String dest;		//destination of message (if "server", ignore it. it usually be the student number of "manager");
