...
// INSTANCE METHODS *************************************************
  ...
  public Board getBrd() {
	...
	public UserListData getUd() {
		return ud;
	}


	public void setUd(UserListData ud) {
		this.ud = ud;
	}
    ...
    try
    {
      ...
      while(!readyToStop)
      {
        try
        {
          ...
          System.out.println("accept occured");
          System.out.println(clientSocket.getInetAddress() + "로부터 연결 요청");
