...
public class UI_main_student extends JFrame {
    ...
    * Create the frame.
    */
   public UI_main_student(StudentOperation sop, ChatClient c) {
	  this.connection = c;
      this.sop = sop;
      this.brd = sop.getBrd();
      ...
      JButton btn_notice = new JButton("공지사항 조회");
      btn_notice.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            if (e.getSource() == btn_notice) {
               dispose();
               
               UI_notice_student notice_student = new UI_notice_student(sop,c);
